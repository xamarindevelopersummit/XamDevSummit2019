...
namespace MSC.ConferenceMate.Repository.Entities.CM
{
    ...
    public partial class SponsorTypeConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<SponsorType>
    {
        public SponsorTypeConfiguration()
            : this("dbo")
        {
        }

        public SponsorTypeConfiguration(string schema)
        {
            ToTable("SponsorType", schema);
            HasKey(x => x.SponsorTypeId);

            Property(x => x.SponsorTypeId).HasColumnName(@"SponsorTypeId").HasColumnType("int").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
