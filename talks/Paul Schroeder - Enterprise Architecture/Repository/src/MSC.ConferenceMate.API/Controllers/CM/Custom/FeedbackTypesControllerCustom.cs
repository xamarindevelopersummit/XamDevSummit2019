	...
	public partial class FeedbackTypesCMController : CMBaseApiControllerAuthorized
	{
		...
		partial void RunCustomLogicAfterUpdatePut(ref entCM.FeedbackType updatedDBItem, ref IRepositoryActionResult<entCM.FeedbackType> result)
		{
			...
			{	// An update/PUT was attempted when it should have been a create/POST.
				...
				var insertResult = Utils.AsyncHelper.RunSync<IRepositoryActionResult<entCM.FeedbackType>>(() => Repo.InsertAsync(localDBItem));
				if (insertResult.Status == Enums.RepositoryActionStatus.Created)
				{   // Insert worked
					result = new RepositoryActionResult<entCM.FeedbackType>(insertResult.Entity, Enums.RepositoryActionStatus.Updated);
				}
			}
		}
