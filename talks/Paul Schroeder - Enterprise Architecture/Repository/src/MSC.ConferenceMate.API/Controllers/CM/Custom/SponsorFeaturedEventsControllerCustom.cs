	...
	public partial class SponsorFeaturedEventsCMController : CMBaseApiControllerAuthorized
	{
		...
		partial void RunCustomLogicAfterUpdatePut(ref entCM.SponsorFeaturedEvent updatedDBItem, ref IRepositoryActionResult<entCM.SponsorFeaturedEvent> result)
		{
			...
			{	// An update/PUT was attempted when it should have been a create/POST.
				...
				var insertResult = Utils.AsyncHelper.RunSync<IRepositoryActionResult<entCM.SponsorFeaturedEvent>>(() => Repo.InsertAsync(localDBItem));
				if (insertResult.Status == Enums.RepositoryActionStatus.Created)
				{   // Insert worked
					result = new RepositoryActionResult<entCM.SponsorFeaturedEvent>(insertResult.Entity, Enums.RepositoryActionStatus.Updated);
				}
			}
		}
