...
namespace MSC.ConferenceMate.API.Controllers.CM
{
	public partial class SessionSessionCategoryTypesCMController : CMBaseApiControllerAuthorized
	{
		...
		// {
		// 	var existingDBItem = Utils.AsyncHelper.RunSync<entCM.SessionSessionCategoryType>(() => Repo.Get_SessionSessionCategoryTypeAsync(sessionId, sessionCategoryTypeId, 1));
