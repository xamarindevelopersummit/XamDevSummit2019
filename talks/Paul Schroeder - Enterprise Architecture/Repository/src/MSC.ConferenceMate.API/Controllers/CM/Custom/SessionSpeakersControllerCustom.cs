...
namespace MSC.ConferenceMate.API.Controllers.CM
{
	public partial class SessionSpeakersCMController : CMBaseApiControllerAuthorized
	{
		...
		// partial void RunCustomLogicBeforeUpdatePut(ref entCM.SessionSpeaker updatedDBItem, int sessionId, int userProfileId)
		// {
		// 	var existingDBItem = Utils.AsyncHelper.RunSync<entCM.SessionSpeaker>(() => Repo.Get_SessionSpeakerAsync(sessionId, userProfileId, 1));
