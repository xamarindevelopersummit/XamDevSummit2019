	...
	public partial class FeedbackInitiatorTypesCMController : CMBaseApiControllerAuthorized
	{
		...
		partial void RunCustomLogicAfterUpdatePut(ref entCM.FeedbackInitiatorType updatedDBItem, ref IRepositoryActionResult<entCM.FeedbackInitiatorType> result)
		{
			...
			{	// An update/PUT was attempted when it should have been a create/POST.
				...
				var insertResult = Utils.AsyncHelper.RunSync<IRepositoryActionResult<entCM.FeedbackInitiatorType>>(() => Repo.InsertAsync(localDBItem));
				if (insertResult.Status == Enums.RepositoryActionStatus.Created)
				{   // Insert worked
					result = new RepositoryActionResult<entCM.FeedbackInitiatorType>(insertResult.Entity, Enums.RepositoryActionStatus.Updated);
				}
			}
		}
		...
		// {
		// 	var existingDBItem = Utils.AsyncHelper.RunSync<entCM.FeedbackInitiatorType>(() => Repo.Get_FeedbackInitiatorTypeAsync(feedbackInitiatorTypeId, 1));
