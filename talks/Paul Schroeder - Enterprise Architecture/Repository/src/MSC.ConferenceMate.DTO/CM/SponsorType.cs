...
namespace MSC.ConferenceMate.DTO.CM
{
	public partial class SponsorType
	{
		...
		public int SponsorTypeId { get; set; } // Primary key
		...
		// public virtual System.Collections.Generic.ICollection<Sponsor> Sponsors { get; set; } // Many to many mapping -- Excluded navigation property per configuration.
